...
public class coffeeChat implements ActionListener {
    ...
    // Method to display the frame with the buttons ======================
    public void coffeChatAction() {
        // =======================
        // JLayeredPane
        // =======================
        ...
        ImageIcon bckground = new ImageIcon("imgs/city/coffeconv.png");
        ...
        friendly.setBackground(Color.decode("#be722e"));
        ...
        romantic.setBackground(Color.decode("#be722e"));
        ...
        mean.setBackground(Color.decode("#be722e"));
        ...
        funny.setBackground(Color.decode("#be722e"));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == friendly) {
            // more 10 love
            petPointer.socialize(10, "npc3"); // sets npc3 love
            ...
            // more 15 love
            petPointer.socialize(15, "npc3"); // sets npc3 love
            // will return to the Library the sprite to be animated
            sprite = 2;
            bol = true;
            frame.dispose();
            ...
            // more 5 love
            petPointer.socialize(5, "npc3"); // sets npc3 love
            // will return to the Library the sprite to be animated
            sprite = 1;
            bol = true;
            frame.dispose();
