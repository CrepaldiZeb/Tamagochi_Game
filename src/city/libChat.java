...
public class libChat implements ActionListener {
    ...
    public void libChatAction() {
        ...
        ImageIcon bckground = new ImageIcon("imgs/city/libconv.png");
        ...
        friendly.setBackground(Color.decode("#9a140c"));
        ...
        romantic.setBackground(Color.decode("#9a140c"));
        ...
        mean.setBackground(Color.decode("#9a140c"));
        ...
        funny.setBackground(Color.decode("#9a140c"));
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == friendly) {
            // more 10 love
            petPointer.socialize(10, "npc1"); // sets npc1 love
            ...
            // more 15 love
            petPointer.socialize(15, "npc1"); // sets npc1 love
            // will return to the Library the sprite to be animated
            sprite = 2;
            bol = true;
            frame.dispose();
            ...
            // more 5 love
            petPointer.socialize(5, "npc1"); // sets npc1 love
            // will return to the Library the sprite to be animated
            sprite = 1;
            bol = true;
            frame.dispose();
